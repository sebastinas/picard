...
class VersionsTest(unittest.TestCase):
    ...
    def test_version_to_string_6(self):
        self.assertRaises(VersionError, version_from_string, 'abc')
        self.assertRaises(VersionError, version_from_string, '')

    def test_version_to_string_7(self):
        self.assertRaises(TypeError, version_to_string, ('1', 0, 2, 'final', 0))
        self.assertRaises(IndexError, version_to_string, (1, 0))
